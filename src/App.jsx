...
const meusProjetos = [
  ...
  },
  {
    ...
    tecnologias: ["JavaScript", "React", "Bootstrap", "Node.js"],
    github: "https://github.com/MatheusTLampugnani/imobilizados"
  },
  {
    id: 4,
    nome: "geek-loop",
...
function App() {
  return (
    <div className="min-h-screen w-full min-w-[100vw] overflow-x-hidden bg-slate-50 font-sans bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] [background-size:24px_24px]">
      
      <header className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-800 text-white py-20 mb-16 shadow-xl rounded-b-[3rem]">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 tracking-tight">Matheus Lampugnani</h1>
          <span className="text-lg md:text-xl font-medium text-indigo-700 bg-white px-6 py-2 rounded-full shadow-sm">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-20 w-full">
        <h2 className="text-3xl font-bold text-slate-800 mb-10 flex items-center justify-center md:justify-start">
          <span className="mr-3 text-4xl">Meus Projetos</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {meusProjetos.map((projeto) => (
            <div key={projeto.id} className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col h-full border border-slate-100 relative overflow-hidden group">
              <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-indigo-500 to-purple-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
              <div className="flex-grow">
                <h3 className="text-2xl font-bold text-slate-800 group-hover:text-indigo-600 transition-colors mb-4">{projeto.nome}</h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-6">{projeto.descricao}</p>
                
                <div className="flex flex-wrap gap-2 mb-8">
                  {projeto.tecnologias.map(tech => (
                    <span key={tech} className="bg-slate-50 text-slate-700 border border-slate-200 text-xs px-3 py-1.5 rounded-lg font-semibold tracking-wide">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              <div className="mt-auto flex gap-3 pt-6 border-t border-slate-100">
                <a 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white text-sm py-2.5 px-4 rounded-xl font-medium transition-colors"
                >
                ...
                {projeto.link ? (
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="flex-1 flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm py-2.5 px-4 rounded-xl font-medium transition-colors shadow-sm"
                  >
      ...
      <section className="w-full bg-white border-t border-slate-200 py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-slate-800 mb-8">Vamos trabalhar juntos?</h2>
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <a href="https://github.com/MatheusTLampugnani" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-800 px-6 py-3 rounded-full font-semibold transition-colors">
              GitHub
            </a>
            <a href="https://linkedin.com/in/SEU_LINKEDIN_AQUI" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-blue-50 text-blue-700 hover:bg-blue-100 px-6 py-3 rounded-full font-semibold transition-colors">
              LinkedIn
            </a>
          </div>

          <div className="flex flex-col items-center justify-center gap-4 text-slate-600 font-medium text-lg">
            <div className="flex items-center gap-3 bg-slate-50 px-6 py-3 rounded-2xl border border-slate-100 shadow-sm">
              ...
              <span>matheuslampugnani123@gmail.com</span>
            </div>
      ...
      <footer className="w-full text-center py-6 bg-slate-50 text-slate-500 text-sm border-t border-slate-200">
